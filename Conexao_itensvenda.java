    ...
    public class Conexao_itensvenda {  
      ...
      public Conexao_itensvenda() {  
         ...
         try {  
            ...
            System.out.println("nao foi possovel conectar ao banco" + e.getMessage());  
         }  
      }  
        
      public void setItv_codigo(int itv_codigo){  
      ...
      public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_itensvenda(itv_codigo,ven_codigo,"
                    + "pro_codigo,tpp_codigo,nf_codigo,"
                    + "tpg_codigo,fun_codigo,itv_embalagem,"
                    + "itv_qtde,itv_valorun,itv_desc,itv_valortotal) "
                    + "values("+itv_codigo+","+ven_codigo+","
                    + ""+pro_codigo+","+tpp_codigo+","
                    + ""+nf_codigo+","+tpg_codigo+","
                    + ""+fun_codigo+",\""+itv_embalagem+"\","
                    + "\""+itv_qtde+"\",\""+itv_valorun+"\","
                    + "\""+itv_desc+"\",\""+itv_valortotal+"\")";   
            stm.executeUpdate(query);  
     
         }catch (SQLException e){System.out.println("Erro na insercao:" + e.getMessage());}  
      ...
      public boolean excluirDados(){  
       ...
       boolean testa = false;  
         ...
         try {  
            String query = "delete from tb_itensvenda where itv_codigo='"+itv_codigo+"'";  
            int linhas = stm.executeUpdate(query);  
        ...
        }catch (SQLException e){System.out.println("Erro na exclusao:"+e.getMessage());}  
     ...
     public boolean consultarDados(){  
        ...
        try {  
           String query = "select * from tb_itensvenda where itv_codigo='"+itv_codigo+"'";  
