 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema/funcionario.jsp?status=Consulta efetuada com sucesso&fun_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema/funcionario.jsp?status=Registro nao encontrado");  
       }  
