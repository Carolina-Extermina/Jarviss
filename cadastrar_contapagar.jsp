<%@ page contentType="text/html" language="java" import="java.sql.*"%>
    ...
    <body>
        <form name="form1 " method="post " action="contapagar.jsp ">
            ...
            <p><strong>Tabela de Conta Pagar </strong></p>
            <table border=1 cellspacing=0 cellpadding=0>

                <tr>
                    <td width=150>
                        <strong>Codigo Conta pagar</strong>
                    </td>
                    <td width=120>
                ...
                <%      
                     try {  
                        ...
                        if(request.getParameter("cp_codigoField").equals(temp.getString("cp_codigo")))  
                           response.sendRedirect("http://localhost:8084/sistema/contapagar.jsp?status=Registro ja existente ");  
            ...
            <p><strong>Status:  
     <input name="statusField " disabled type="text " id="statusField " size="36 " value="<%=Integer.parseInt(request.getParameter("cp_codigoField"))%> foi cadastrado com sucesso">
        </strong>
            </p>
        </form>
    </body>
