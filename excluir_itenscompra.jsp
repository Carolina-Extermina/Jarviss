 ...
 <%      
    try {  
       ...
       {  
          ...
          response.sendRedirect("http://localhost:8084/sistema/itenscompra.jsp?status=Registro n�o encontrado");  
       }     
    }catch (Exception e) {  
       e.printStackTrace();  
    }  
 ...
 %>  
   ...
   <p><strong>Status:  
     <input name="statusField" disabled type="text" id="statusField" size="36" value="<%=request.getParameter("itc_codigoField")%> foi excluido com sucesso">  
       </strong></p>  
 </form>  
 </body>  
 </html> 