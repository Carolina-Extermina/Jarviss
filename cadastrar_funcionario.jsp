<%@ page contentType="text/html" language="java" import="java.sql.*"%>
    ...
    <body>
        <form name="funm1 " method="post " action="funcionario.jsp ">
            ...
            <p><strong>Tabela de funcionario </strong></p>
            <table border=1 cellspacing=0 cellpadding=0>
                ...
                <%      
                     try {  
                        ...
                        con.setFun_bairro(request.getParameter("fun_numeroField"));  
                        ...
                        if(request.getParameter("fun_codigoField").equals(temp.getString("fun_codigo")))  
                           response.sendRedirect("http://localhost:8084/sistema/funcionario.jsp?status=Registro ja existente");  
            ...
            <p><strong>Status:  
     <input name="statusField" disabled type="text" id="statusField" size="36" value="<%=Integer.parseInt(request.getParameter("fun_codigoField"))%> foi cadastrado com sucesso">
        </strong>
            </p>
        </funm>
    </body>
